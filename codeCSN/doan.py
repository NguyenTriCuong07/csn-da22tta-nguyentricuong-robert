...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(310, 520, 111, 61))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_3.clicked.connect(self.edit_image)
    ...
    def upload_image(self):
        try:
            ...
            try:
                ...
                edges_pixmap = QtGui.QPixmap.fromImage(edges_qimage)
    ...
    def edit_image(self):
        QtWidgets.QMessageBox.information(None, "Thông báo", "Tính năng sửa ảnh chưa được triển khai.")
